    ...
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md h-14 border-b transition-colors bg-white/95 dark:bg-[#120f24]/95 border-slate-200/90 dark:border-purple-950/60 text-slate-800 dark:text-slate-100 shadow-xs">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-1.5 sm:space-x-2">
          ...
          {user ? (
            <>
              {/* Account Switcher & Wallet Display (Screenshot 1: [ R ] $ 0.00 v) */}
              ...
              {/* Deposit Quick Action Button (Screenshot 1: solid purple rounded button) */}
              <Link
                href="/deposit"
              ...
              {/* Notification Bell Button (Screenshot 1) */}
              <button
      ...
      {/* Side Drawer Menu (Matching Screenshot 2 exactly!) */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 flex animate-fade-in">
          ...
          <div className="relative w-72 sm:w-80 bg-[#120e26] border-r border-[#241a45] text-white flex flex-col justify-between h-full shadow-2xl z-50 overflow-y-auto animate-slide-right">
            <div>
              {/* Drawer Header */}
